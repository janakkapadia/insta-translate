...
<body class="bg-gray-50 text-gray-800 font-sans antialiased gradient-bg min-h-screen">
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8" x-data="translationDashboard()">
        ...
        <div class="mb-8 flex justify-between items-end">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Missing Translations</h1>
                <p class="mt-1 text-sm text-gray-500">Review, generate, and approve missing translation keys across all locales.</p>
            </div>
